             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     ...
                     <form id="frmnuevo" onsubmit="nuevoUsuario()" action="" method="post">
                         ...
                         <div class="row">
                             <div class="col-sm">
                                 <input type="radio" name="permisos" value="Admin">Administrador
                             </div>
                             <div class="col-sm"> <input type="radio" name="permisos" checked value="Gestor">Gestor</div>
                         </div>
                         <div class="row">
                             <div class="col-sm">
                                 <input type="radio" name="permisos" value="Vendedor">Vendedor
                             </div>
                             <div class="col-sm">
                                 <input type="radio" name="permisos" value="Telemarketer">Telemarketer
                             </div>
                         </div>
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     <form id="frmactualizar" onsubmit="actualizarGuardarUsuario()" action="" method="post">
                         ...
                         <div class="row">
                             <div class="col-sm">
                                 <input type="radio" name="permisosE" id="padU" value="administrador">Administrador
                             </div>
                             <div class="col-sm"> <input type="radio" id="pgeU" name="permisosE" checked value="gestor">Gestor</div>
                         </div>
                         <div class="row">
                             <div class="col-sm">
                                 <input type="radio" name="permisosE" id="pveU" value="vendedor">Vendedor
                             </div>
                             <div class="col-sm">
                                 <input type="radio" name="permisosE" id="pteU" value="telemarketer">Telemarketer
                             </div>
                         </div>
