...
switch ($_GET['pme']) {
    ...
    case 'c':
		...
		break;
	case 'er':
			$sql="SELECT v.marca,v.modelo,v.anio,v.kilometros,v.color,v.id,v.id_estado,v.dominio_patente,v.fecha_ingreso_a_stock,v.eliminado,v.fecha_vendido,v.fecha_ingreso,o.descripcion,v.precio_compra,v.precio_venta,v.info_precio,v.nombre_vehiculo_infoauto  FROM vehiculos v,origenes_vehiculo o WHERE v.id_estado='6' and v.eliminado='NO'  and o.id=v.id_origen";        
			break;	
			...
			<tbody>
				...
				<tr style="background-color: white;">
				    ...
				    <td style="font-size: 9px"> <?php 
				    	if($mostrar[6]=='1'){
				    		echo "<div title=\"A Ingresar\" class=\"alert alert-warning\" role=\"alert\" style=\"height:30px; width:60px;\">I</div> "; 
				    	}
				    		else if ($mostrar[6]=='2') {echo "<div title=\"Stock\" class=\"alert alert-success\" role=\"alert\" style=\"height:30px; width:60px;\" >S</div> "; }
				    		else if ($mostrar[6]=='3') {echo "<div title=\"Reservado\" class=\"alert alert-info\" role=\"alert\" style=\"height:30px; width:60px;\" >R</div> "; }
				    		else if ($mostrar[6]=='4') {echo "<div title=\"Vendido\" class=\"alert alert-dark\" role=\"alert\" style=\"height:30px; width:60px;\" >V</div> "; }
				    		else if ($mostrar[6]=='5') {echo "<div title=\"Cancelado\" class=\"alert alert-danger\" role=\"alert\" style=\"height:30px; width:60px;\" >C</div> "; }
							else if ($mostrar[6]=='6') {echo "<div title=\"Revision PreVenta\" class=\"alert alert-light\" role=\"alert\" style=\"height:30px; width:60px;\" >RPV</div> "; }
