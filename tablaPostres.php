...
from postres p, tipo_postres tp where p.id_postre=tp.id and p.eliminado='NO' ";
			...
			<tbody>
				...
				<tr style="background-color: white;">
					...
					<td style="font-size: 12px"> <?php echo $mostrar[5]?></td>
							...
							<td>
							<span class="btn btn-warning btn-sm" data-toggle="modal"   data-target="#modalEditarBebida" onclick="actualizarPostre('<?php echo $mostrar[6] ?>')">
						<span class="fas fa-edit "></span>
						</span>
						<span class="btn btn-danger btn-sm" title="Eliminar" onclick="eliminarDatosPostre('<?php echo $mostrar[6] ?>')">
