			...
			<tbody>
				...
				<!-- quedaste aca segui desde el eliminar y actualizar los datos
					  -->
						...
						<td> 
						<span class="btn btn-warning btn-sm" data-toggle="modal"   data-target="#modalEditar" onclick="actualizarTipoPostre('<?php echo $mostrar[0] ?>')">
						<span class="fas fa-edit "></span>
						</span>
						
						<span class="btn btn-danger btn-sm" onclick="eliminarDatosTipoPostre('<?php echo $mostrar[0] ?>')">
