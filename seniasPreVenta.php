                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                           ...
                           <!--   <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="gestionarPagos.php"  id="linkGestionarPagos" aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-dollar-sign"></i>Ventas Existentes</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#"  aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-money-bill-wave"></i>Señas Pre-Ventas</a>
        ...
        <div class="row">
            ...
            <div class="col-sm-1" > 
               <select id="filSelect" name="filSelect" class="mi-selectorVehiculos">
                  ...
                  <option  value="en">Entregadas</option>
                  <option  value="a">Rendidas</option>
                  <option  value="r">Canceladas</option>
...
<!-- Modal señar preventa -->
<div class="modal fade" id="agregarnuevosdatosmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Señar Pre Venta</h5>
...
<form id="frmnuevaSenia" onsubmit="nuevaSenia()"  action="" method="post">


<div class="col-sm-4">
    <label style="font-size: 14px;">Monto Seña</label>
        </div>
        <div class="col-sm-5">
    <input style="text-transform: capitalize; height: 25px"  type="text"  class="form-control input-sm" id="montoSenia" name="montoSenia"  minlength="1" maxlength="24" pattern="[0-9]+(\.[0-9]{1,2})?%?">
  </div>
	
</div>
<input hidden style="text-transform: capitalize; height: 25px"  type="text"  class="form-control input-sm" id="idPreS" name="idPreS">
  ...
  <div class="modal-footer">
        ...
        <button type="submit" id="btnAgregarNuevo" class="btn btn-primary" >Señar</button>
      </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaSeniasPreventa.php?pme=t');
    });
...
<script type="text/javascript">
    ...
    function recibirSenia(id){
    alertify.confirm('Señar', '¿Esta seguro que desea registrar esta Seña?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/recibirSenia.php",
        success:function(r){
...
function cancelarSenia(id){
    alertify.confirm('Cancelar Seña', '¿Esta seguro que desea Cancelar esta seña?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/cancelarSenia.php",
        success:function(r){
...
if('<?php echo $_SESSION["permisos"];?>'=='3' ){ // esto es si es un vendedor
    ...
    document.getElementById('linkGestionarPagos').hidden=true;
...
$(document).ready(function(){
    $("select[name=filSelect]").change(function(){
        ...
        var load='tablaSeniasPreventa.php?pme='+ $('select[name=filSelect]').val();
...
function nuevaSenia(){
        ...
        datos=$('#frmnuevaSenia').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/guardarSenia.php",
            success:function(){
