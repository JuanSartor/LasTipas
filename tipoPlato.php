                             ...
                             <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Tipo de Platos</a>
                                        </li>
                                        <li class="nav-item">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nuevo Tipo de Plato</h5>
...
<form id="frmnuevo" onsubmit="nuevoTipoPlato()"  action="" method="post">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Actualizar Tipo Plato</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="frmactualizar"  onsubmit="actualizarGuardarTipoPlato()"  action="" method="post">
    

	<label>Descripcion <label style="color: red;">*</label></label>
    <input type="text" class="form-control input-sm" id="descripcionU" name="descripcionU" required minlength="2" maxlength="49">
    
	<input type="text" hidden="true" class="form-control input-sm" id="idU" name="idU"  >
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaTipoPlato.php');
    });
...
function nuevoTipoPlato(){

datos=$('#frmnuevo').serialize();
 		$.ajax({
 			type:"POST",
 			data:datos,
 			url:"procesos/agregarTipoPlato.php",
 			success:function(){
...
function actualizarGuardarTipoPlato(){
        datos=$('#frmactualizar').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarTipoPlato.php",
            success:function(){
...
function actualizarTipoPlato(id){
    $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/obtenerDatosTipoPlato.php",
        success:function(r){
...
function eliminarDatosTipoPlato(id){
    alertify.confirm('Eliminar Tipo Plato', '¿Esta seguro que desea eliminar este tipo?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarTipoPlato.php",
        success:function(r){
