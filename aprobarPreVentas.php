...
function editarOrdenPreVenta(id){
  window.location.href='preVenta.php?datos='+btoa(id) +'&datos33='+btoa(14);
...
function nuevaSenia(){
    ...
    monto= document.getElementById('montoSenia').value;
    id= document.getElementById('idPreS').value;
        ...
        window.open('procesos/pdfVentanaSenia.php?montoSenia='+monto+'&idPreS='+id,'_blank');
