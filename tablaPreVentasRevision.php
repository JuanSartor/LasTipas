...
// con esta consulta obtengo el registro con mayor edicion es decir la ultima edicion guardada
		...
		usuarios.nombre,usuarios.apellido,operacion_preventa.tiene_senia
				...
				<tr style="background-color: white;">
				   ...
				   ?> </td>
					...
					<td> 
						...
						// verifico que no sea un vendedor
						if($_SESSION["permisos"]!='3'){ 
							

							//verifico que el estado no este en aprobado o cancelada la preventa
...
<?php  } } 
							...
							if($mostrar[8]!='1' and $mostrar[5]=='0' ){

?>

			<span class="btn btn-success btn-sm" data-toggle="modal" title="Señar"   data-target="#agregarnuevosdatosmodal" onclick="setearIdPrSenia('<?php echo $mostrar[0] ?>')" >
...
<span class="btn btn-success btn-sm disabled" data-toggle="modal" title="Señar" >
						<span class="fas fa-money-bill-wave" ></span>
						</span>
