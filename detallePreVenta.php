...
<div class="col-sm-2">
                <button   onclick="aprobarPreVenta()"     class="btn btn-success" >Aprobar</button>
                </div>
                
                <div class="col-sm-2">
                <button   onclick="rechazarPreVenta();"     class="btn btn-danger" >Rechazar</button>
                </div>
                <div class="col-sm-2">
                <button   onclick="revisarPreVenta()"     class="btn btn-primary" >Corregir</button>
                </div>
</div>
...
alertify.prompt("Rechazar Pre Venta","Motivo", "",
function(evt, value ){
$.ajax({
type:"POST",
data:"id=" + id + "&descripcion=" + value,
url:"procesos/rechazarPreVenta.php",
success:function(r){
...
error: function(){
  ...
  alertify.error("No se pudo concretar la operacion");
