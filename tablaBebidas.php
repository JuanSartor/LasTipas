...
$sql="SELECT b.id_real,b.descripcion,b.tamanio,b.precio,b.canti_disponible,tb.descripcion,b.id   
from bebidas b, tipo_bebidas tb where b.id_bebida=tb.id and b.eliminado='NO' ";
			...
			<tbody>
				...
				<tr style="background-color: white;">
					...
					<td style="font-size: 12px"> <?php echo $mostrar[5]?></td>
							...
							<td>
							<span class="btn btn-warning btn-sm" data-toggle="modal"   data-target="#modalEditarBebida" onclick="actualizarBebida('<?php echo $mostrar[6] ?>')">
						<span class="fas fa-edit "></span>
						</span>
						<span class="btn btn-danger btn-sm" title="Eliminar" onclick="eliminarDatosBebida('<?php echo $mostrar[6] ?>')">
