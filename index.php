              ...
              <!-- <a class="navbar-brand" href="index.php" style="text-transform: capitalize; font-family:sans-serif; color: firebrick; font-size: 25px;"> <i class="fas fa-car-alt" style="color: darkred;"></i> AutoGaba <i class="fas fa-car-alt" style="color: darkred;"></i></a> -->
                 <!--  <a class="navbar-brand" href="#">  <img src="static/img/gaba.jpeg" height="40" width="40"></a>
                  <i class="fas fa-car-alt" style="color: darkred;"></i> AutoGaba <i class="fas fa-car-alt" style="color: darkred;"></i> -->
                   <a class="navbar-brand" href="#">  <img src="static/img/logo.jpg" height="48" width="48"></a>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 title="Cantidad de autos en estado Reservado"  style="font-size: 18px;" class="mb-1"></h1>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            ...
                                            <h1 title="Dinero que le deben a la empresa teniendo en cuenta las preventas no canceladas en su totalidad" style="font-size: 18px;"  class="mb-1"></h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 title="Cantidad de autos en estado Vendido" style="font-size: 18px;" class="mb-1"></h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 title="Sumatoria de los precio de ventas de los vehiculos en estado vendido" style="font-size: 18px;" class="mb-1" id="autosStock"></h1>
                                        </div>
                                       <!--  <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span><i class="fa fa-fw fa-arrow-up"></i></span><span>5.86%</span>
                                        </div> -->
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 title="Sumatoria del valor de los creditos prendarios aceptados" style="font-size: 18px;" class="mb-1"></h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <!-- este saldo es lo q le deben a la empresa -->  
                                            <h1 style="font-size: 18px;" title="Sumatoria del valor de los creditos prendarios A Confirmar" class="mb-1"><</h1>
                                        </div>
