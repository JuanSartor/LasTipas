...
<head>
    ...
    $mostrarloguin=mysqli_fetch_array($resultadologuin);
      ...
      $bandeProviene=base64_decode($_GET['datos33']);
      if($bandeProviene=='14'){
        $edicionSinAprobarr='1';
        $banderaAcceso='1';
      }
      else{

        $banderaAcceso=base64_decode($_GET['datos33']);
        $edicionSinAprobarr='0';
      }
...
<input type="hidden" id="edicionSinAprobar" name="edicionSinAprobar">
...
<script type="text/javascript">
    ...
    if('<?php echo $banderaAcceso;?>'=='1'){
      document.getElementById('edicionSinAprobar').value='<?php echo $edicionSinAprobarr;?>';
