                             ...
                             <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Tipo de Bebidas</a>
                                        </li>
                                        <li class="nav-item">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nuevo Tipo de Bebida</h5>
...
<form id="frmnuevo" onsubmit="nuevoTipoBebida()"  action="" method="post">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmactualizar"  onsubmit="actualizarGuardarTipoBebida()"  action="" method="post">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaTipoBebidas.php');
    });
...
function nuevoTipoBebida(){

datos=$('#frmnuevo').serialize();
 		$.ajax({
 			type:"POST",
 			data:datos,
 			url:"procesos/agregarTipoBebida.php",
 			success:function(){
...
function actualizarGuardarTipoBebida(){
        datos=$('#frmactualizar').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarTipoBebida.php",
            success:function(){
...
function actualizarTipoBebida(id){
    $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/obtenerDatosTipoBebida.php",
        success:function(r){
...
function eliminarDatosTipoBebida(id){
    alertify.confirm('Eliminar Tipo Bebida', '¿Esta seguro que desea eliminar este tipo?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarTipoBebida.php",
        success:function(r){
