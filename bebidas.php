                            ...
                            <li class="nav-item" id="linkAutomoviles" name="linkAutomoviles">
                                ...
                                <div id="submenu-88" class="collapse submenu show ">
                                    <ul class="nav flex-column">
                                          <li class="nav-item ">
                                  <a class="nav-link active" href="#"   aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fas fa-glass-cheers"></i>Bebidas</a>
...
<div class="modal fade" id="agregarnuevosdatosmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nueva Bebida</h5>
    ...
    <form id="frmnuevo" onsubmit="nuevaBebida()"  action="" method="post">
    ...
    $sqlTipoBeb= "SELECT id,descripcion from tipo_bebidas where eliminado='NO' order by LENGTH(descripcion) desc";
 ...
 <br>
    ...
    <div class="row">
        <div class="col-sm-3" >
    <label >Tipo Bebida <label style="color: red;">*</label></label>
</div>
  <div class="col-sm-6" >
...
<div class="modal fade" id="modalEditarBebida" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form id="frmeditarBebida" onsubmit="actualizarGuardarBebida()"  action="" method="post">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaBebidas.php');
    });
...
<script type="text/javascript">
    function nuevaBebida(){
        ...
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/agregarBebida.php",
            success:function(){
...
function eliminarDatosBebida(id){
    alertify.confirm('Eliminar Bebida', '¿Esta seguro que desea eliminar esta Bebida?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarBebida.php",
        success:function(r){
...
function actualizarBebida(id){
    $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/obtenerDatosBebida.php",
        success:function(r){
...
function actualizarGuardarBebida(){
        datos=$('#frmeditarBebida').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarBebida.php",
            success:function(){
